...
<body>
    <div class="left-container">
		...
		<a href=""	 class="dashboard3" id="active"><img src="profileicon.png" class="icons"><span class="dashtext">Profile</span></a>
		<a href="dashdash.php?doctor_id=<?php echo $doctor_id;?>"	 class="dashboard5" id="notactive"><img src="patient.png" class="icons"><span class="dashtext">Patients</span></a>
		<div style="width: 100%;
    height: auto;
			   ...
			   <div class="container">
						...
						<div class="overlap-container">
                                ...
                                <input type="text" class="field" name="fname" value="<?php echo isset($row["firstName"]) ? $row["firstName"] : ''; ?>"></input>
														...
														<div class="minibox4"><span class="smoltext">Gender</span>
																				<select id="gender" class="fieldz" name="sex">
						...
						<div class="overlap-container1">
								...
								<div class="minibox6"><span class="smoltext">Area of Expertise</span>
																				<select id="gender" class="fieldz" name="expertise">
																					<option value="<?php echo $row["Expertise"]?>" selected><?php echo $row["Expertise"]?></option>
								...
								<div class="minibox7"><span class="smoltext">E-mail</span>																				
                                                                                ...
                                                                                <input type="text" class="field1" name="email" value="<?php echo isset($row["email"]) ? $row["email"] : ''; ?>" pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" required></input>
																						</div>
								</div>
