...
line-height: normal;
        ...
        transparent 10.7%, /* No background until 10.7% */
        #0C3C68 10.7%,    /* Gradient starts at 10.7% */
        #2DA6B6 100%);    /* Gradient finishes at 100% */
 ...
 include 'editteeth.php'; ?>
  ...
  <?php if ($patient): ?>
    ...
    <div class="patientcontainer">
      ...
      <div class="flexcontainer">
        <span class="b">Patient Name</span>
        <span class="patientName"><?php echo htmlspecialchars($patient['firstName']); ?> <?php echo htmlspecialchars($patient['middleName']); ?> <?php echo htmlspecialchars($patient['lastName']); ?></span>
      </div>
      <div class="flexcontainer">
      ...
      <div class="flexcontainer">
        ...
        <span class="sex"><?php echo htmlspecialchars($patient['sex']); ?></span>
      </div>
      <div class="flexcontainer">
        <span class="b">Birthdate</span>
        <span class="birthdate"><?php echo htmlspecialchars($patient['birthdate']); ?></span>
      </div>
      <div class="flexcontainer">
        <span class="b">Email</span>
        <span class="email"><?php echo htmlspecialchars($patient['email']); ?></span>
      </div>    
      <div class="flexcontainer">
  ...
  <?php endif; ?>
															...
															<div class="patientcontainer2">
																					<div class="flexcontainer1">
																						<span style="font-family:Roboto;font-size:15px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Diagnosis History</span>
																						<img src="diag.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																						
																						<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:red;margin-top:10px; margin-left:5px;background:none;outline:none;border:none;" hidden>Cancel</button>
																					</div>
																					<div class="flexcontainergrey" style="border-top: 0px;
																														  border-right: 0px;
																														  border-bottom: 1px solid #D3D3D3;
																														  border-left: 0px;padding-bottom:9px;">
																						<span class="leftalign">Type</span><span>Date(ymd)</span>
																					</div>
																					...
																					$diagnosisQuery = "SELECT `diagnosis_id`, `diagnosisName`, `diagnosisDate` 
																									   ...
																									   LIMIT 4"; // Limit to 4 records and order by diagnosisDate ascending
																					...
																					// Display each diagnosis record in the format of a span
																					if ($diagnosisResults->num_rows > 0) {
																						while ($diagnosisRecord = $diagnosisResults->fetch_assoc()) {
																							echo '<div class="flexcontainernoline">';
																							echo '<span class="align">' . htmlspecialchars($diagnosisRecord['diagnosisName']) . '</span>';
																							echo '<span>' . date('Y-m-d', strtotime($diagnosisRecord['diagnosisDate'])) . '</span>';
																							echo '</div>';
																						}
																					} else {
																					...
																					?>
																					<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;"><a href="diagedit.php?patientid=<?php echo $patientid;?>"><button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;hover:pointer;">Manage</button></a></div>	
																				</div>
																				...
																				<!-- PRESCRIPTION HISTORY-->	
																										...
																										$prescriptionQuery = "SELECT `prescriptionID`, `prescriptionName`, `prescriptionDate`, `patientid`
																															   ...
																															   LIMIT 4"; // Limit to 4 records and order by prescriptionDate ascending
																										$prescriptionStatement = $databaseConnection->prepare($prescriptionQuery);
																										$prescriptionStatement->bind_param("i", $targetPatientId);
																										$prescriptionStatement->execute();
																										$prescriptionResults = $prescriptionStatement->get_result();
																										?>

																										<div class="patientcontainer3">
																											<div class="flexcontainer1">
																												<span style="font-family:Roboto;font-size:15px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Prescription History</span>
																												<img src="presc.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																												
																												<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:red;margin-top:15px; margin-left:5px;background:none;outline:none;border:none;" hidden>Cancel</button>
																											</div>
																											...
																											<div class="flexcontainergrey" style="border-top: 0px;
																																				...
																																				border-bottom: 1px solid #D3D3D3;
																																				border-left: 0px;padding-bottom:9px;">
																												<span class="leftalign">Name of Prescription</span><span>Date(ymd)</span>
																											</div>

																											<?php
																											if ($prescriptionResults->num_rows > 0) {
																												while ($prescriptionRecord = $prescriptionResults->fetch_assoc()) {
																													echo '<div class="flexcontainernoline">';
																													echo '<span class="align">' . htmlspecialchars($prescriptionRecord['prescriptionName']) . '</span>';
																													echo '<span>' . date('Y-m-d', strtotime($prescriptionRecord['prescriptionDate'])) . '</span>';
																													echo '</div>';
																												}
																											} else {
																												echo "<p>No prescription records found for patient ID $targetPatientId.</p>";
																											}
																											?>

																											<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
																												<a href="presedit.php?patientid=<?php echo $patientid;?>"><button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;hover:pointer;">Manage</button></a>
																											</div>	
																										</div>
																										...
																										$treatmentQuery = "SELECT `treatmentID`, `treatmentName`, `treatmentDate`, `patientid`
																														   ...
																														   LIMIT 4"; // Limit to 4 records and order by treatmentDate ascending
																										$treatmentStatement = $databaseConnection->prepare($treatmentQuery);
																										$treatmentStatement->bind_param("i", $targetPatientId);
																										$treatmentStatement->execute();
																										$treatmentResults = $treatmentStatement->get_result();
																										?>

																										<div class="patientcontainer4">
																											<div class="flexcontainer1">
																											...
																											<div class="flexcontainergrey" style="border-top: 0px;
																																				  ...
																																				  border-bottom: 1px solid #D3D3D3;
																																				  border-left: 0px;padding-bottom:9px;">
																												<span class="leftalign">Name of Treatment</span><span>Date(ymd)</span>
																											</div>
																											...
																											if ($treatmentResults->num_rows > 0) {
																												while ($treatmentRecord = $treatmentResults->fetch_assoc()) {
																													echo '<div class="flexcontainernoline">';
																													echo '<span class="align">' . htmlspecialchars($treatmentRecord['treatmentName']) . '</span>';
																													echo '<span>' . date('Y-m-d', strtotime($treatmentRecord['treatmentDate'])) . '</span>';
																													echo '</div>';
																												}
																											} else {
																											...
																											<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
																												<a href="treatmentedit.php?patientid=<?php echo $patientid;?>"><button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;">Manage</button></a>
																											</div>
																										</div>
															...
															<div class="patientcontainer5">
																<div class="flexcontainer1">
																<span style="font-family:Roboto;font-size:20px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Teeth History</span><img src="teeth.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																	...
																	<?php
																		...
																		foreach ($toothData as $data) {
																			...
																			if (strtolower($data['issue']) == 'other') {
																				...
																				echo '<span>&nbsp;</span>';  // Blank space for background
																			} else {
																	...
																	<!-- <div class="align" style="margin-top:28px;border:#009688 2px solid;width:148px;height:33px;border-radius:10px;color:#009688;text-align:center;display:flex;flex-direction:row;align-items:center;justify-content:center;"><img src="edit.png" style="width:20px;height:20px;"><span style="margin-left:7px;font-family:Roboto;font-size:12px;font-weight:bold;">Edit</span>
																				
																	</div>	-->
																	

																														<!-- Teeth Selection -->
																														<form method="POST" action="teeth_submit.php?patientid=<?php echo $patientid;?>">
    ...
    function toggleOtherInput() {
        ...
        if (selectElement.value === "other") {
            ...
            otherInput.setAttribute("required", "true");  // Make 'Other' input required
        } else {
            otherInputDiv.style.display = "none";
            otherInput.removeAttribute("required");  // Remove 'required' when not 'Other'
        }
    }
</script>
																	...
																	<div style="width:550px;height:800px;background:#FFFFFF;margin-left:206px; position:absolute;top:90px;left:500px;">
    ...
    <form action="note.php?patientid=<?php echo $patientid;?>" method="POST">
        <input name="note" type="text" style="width:400px; height:200px;" value="<?php echo isset($s) ? htmlspecialchars($s) : ''; ?>">
